...
del servidor. En el cliente, la capa de protocolo resuelve conexión, framing,
negociación y lectura de respuestas. La capa de terminal construye cada pedido e
interpreta el resultado para mostrar listas, métricas, confirmaciones o errores.
El cliente usa I/O bloqueante porque atiende una sola operación interactiva por
proceso; esa elección no afecta la concurrencia del servidor.
